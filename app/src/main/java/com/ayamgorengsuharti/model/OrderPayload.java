...
public class OrderPayload {
    ...
    public OrderPayload(List<OrderItemPayload> cartItems, String nama_pelanggan, String tipe_pesanan, String nomor_wa, double total_harga, int metode_pembayaran_id, String catatan_pelanggan) {
